 ...
 */
	public function testExecute() {
		...
		$this->Task->params['paths'] = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'main';
 ...
 */
	public function testExtractWithExclude() {
		...
		$this->Task->params['output'] = $this->path . DS;
		$this->Task->params['exclude'] = 'main,Layouts';
		$this->Task->params['extract-core'] = 'no';
 ...
 */
	public function testExtractMultiplePaths() {
		...
		$this->Task->params['paths'] =
			CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'main,' .
 ...
 */
	public function testExtractPlugin() {
		...
		$this->Task->execute();
		$result = file_get_contents($this->path . DS . 'default.pot');
		$this->assertNotRegExp('#main#', $result);
