 ...
 */
	public function testGetTemplate() {
		...
		$this->Controller->name = 'main';
		$this->Controller->viewPath = 'main';
		$this->Controller->action = 'display';
		$this->Controller->params['pass'] = array('home');

		$ThemeView = new TestThemeView($this->Controller);
		$ThemeView->theme = 'test_theme';
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'main' . DS . 'index.ctp';
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'main' . DS . 'page.index.ctp';
 ...
 */
	public function testMissingView() {
		...
		$this->ThemeController->name = 'main';
		$this->ThemeController->viewPath = 'main';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('/main/home');
		$this->assertRegExp('/main(\/|\\\)index.ctp/', $result);
